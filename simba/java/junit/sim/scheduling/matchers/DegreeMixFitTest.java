...
public class DegreeMixFitTest
{
	...
	public void testNoAccpetingHostNotFit()
	{
		...
		assertNull(GradeMatcherProvider.createGraderMf1().match(Job.create(1).cores(1).build(), hosts));
	}
	...
	public void testAccpetingHostFit()
	{
		...
		assertEquals(host, GradeMatcherProvider.createGraderMf1().match(Job.create(1).cores(1).build(), hosts));
	}
	...
	public void testAccpetingBestHost()
	{
		...
		assertEquals(host3, GradeMatcherProvider.createGraderMf1().match(Job.create(1).cores(1).memory(4).build(), hosts));
	}
	...
	public void testWhenEqualsUsingLessAvailableMemoryHost()
	{
		...
		assertEquals(host2, GradeMatcherProvider.createGraderMf1().match(Job.create(1).cores(1).memory(4).build(), hosts));
	}
