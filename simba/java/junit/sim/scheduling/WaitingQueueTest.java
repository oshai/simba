...
public class WaitingQueueTest
{
	...
	{
		Job job0 = Job.builder(1).priority(0).build();
		Job job1 = Job.builder(1).priority(1).build();
		Job job2 = Job.builder(1).priority(2).build();
		Job job3 = Job.builder(1).priority(3).build();
		AbstractWaitingQueue waitingQueue = new LinkedListWaitingQueue();
