...
public class HostTest
{
	...
	{
		Host host = Host.builder().cores(0).memory(0).build();
		Job job = Job.builder(1).cores(1).build();
	...
	{
		Host host = Host.builder().cores(1).memory(0).build();
		Job job = Job.builder(1).cores(1).build();
	...
	{
		Host host = Host.builder().cores(0).memory(0).build();
		Job job = Job.builder(1).memory(1).build();
		assertFalse(host.hasAvailableResourcesFor(job));
	}
	...
	{
		Host host = Host.builder().cores(0).memory(1).build();
		Job job = Job.builder(1).memory(1).build();
		assertTrue(host.hasAvailableResourcesFor(job));
		host.dispatchJob(job);
		assertFalse(host.hasAvailableResourcesFor(job));
	...
	{
		Host host = Host.builder().cores(0.1).memory(1.1).id("id").build();
	...
	{
		Host host = Host.builder().cores(2).memory(1).build();
		Job job = Job.builder(1).cores(2).cost(1.5).memory(1).build();
		assertEquals(0, host.usedCores(), 0.1);
		assertEquals(0, host.usedMemory(), 0.1);
		assertEquals(0, host.usedCost(), 0.1);
		host.dispatchJob(job);
		assertEquals(2, host.usedCores(), 0.1);
		assertEquals(1, host.usedMemory(), 0.1);
		assertEquals(1.5, host.usedCost(), 0.1);
		host.finishJob(job);
		assertEquals(0, host.usedCores(), 0.1);
		assertEquals(0, host.usedMemory(), 0.1);
		assertEquals(0, host.usedCost(), 0.1);
	...
	{
		Host host = Host.builder().cores(2).memory(1).build();
		Job job = Job.builder(1).cores(2).memory(1).build();
	...
	{
		Host host = Host.builder().cores(2).memory(1).build();
		Job job = Job.builder(1).cores(3).memory(1).build();
